...
- Delivery-clause coverage must include common execution verbs such as design, integrate, ship, manage, architect, create, launch, scale, maintain, and configure.
