...
- The deploy-only verifier now follows the current required fixture set exactly. After Netflix was disabled in the live URL fixture on 2026-04-29, the required Cloudflare deploy gate is Waymo + Sourgum + Motive unless the fixture changes again.
